...
#func _ready() -> void: values = Request.select(Request.Tables.CASH_FLOWS, "*", "section_id IN (2,3,4) AND wallet_2_id="+str(get_parent().id), "date")
